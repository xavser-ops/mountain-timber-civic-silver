...
//#region node_modules/.nitro/vite/services/ssr/assets/router-sZu0a1CL.js
var router_sZu0a1CL_exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-BYcRO0zL.css";
var APP_NAME = "Planifier la Finlande";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Planificateur de circuits premier séjour en Finlande : on part d’une ossature, on l’adapte."
			},
			{
...
var $$splitComponentImporter$2 = () => import("./routes-CK4W-awU.mjs");
var Route$3 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./login-ldorM0qd.mjs");
var Route$2 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./planificateur-CP6URyDF.mjs");
var Route$1 = createFileRoute("/planificateur")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
/**
...
var rootRouteChildren = {
	...
	PlanificateurRoute: Route$1.update({
		id: "/planificateur",
		path: "/planificateur",
		getParentRoute: () => Route$4
	}),
...
//#endregion
export { router_sZu0a1CL_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
