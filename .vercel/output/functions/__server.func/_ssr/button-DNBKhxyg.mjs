...
import { i as getBaseURL, r as PACKAGE_VERSION, t as GENERIC_OAUTH_ERROR_CODES } from "./router-sZu0a1CL.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/button-DNBKhxyg.js
...
function SiteHeader() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: "site-header border-b border-border bg-bg",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					className: "hidden text-xs font-medium tracking-wide text-muted uppercase sm:inline",
					children: "Planifier la Finlande"
				})]
				...
				}), isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-8 w-8 animate-pulse rounded-full bg-surface" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SignedOut, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/login",
...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		className: "site-footer mt-auto border-t border-border py-8 text-sm text-subtle",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "page-wrap flex flex-col gap-2 sm:flex-row sm:justify-between",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Circuits premier séjour — autonome, A/R Helsinki." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Pas un tour opérateur. Chiffrage indicatif." })]
		})
	});
}
function cn(...inputs) {
...
function Button({ className, variant = "primary", ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		className: cn("inline-flex min-h-11 items-center justify-center gap-2 rounded-lg px-4 text-sm font-semibold tracking-tight transition-opacity duration-150 disabled:cursor-not-allowed disabled:opacity-40", variant === "primary" && "bg-primary text-primary-fg hover:bg-primary-hover", variant === "secondary" && "border border-border-strong bg-card text-fg hover:bg-bg-elevated", variant === "ghost" && "text-muted hover:bg-bg-elevated hover:text-fg", variant === "moss" && "bg-moss text-moss-fg hover:opacity-90", className),
		...props
	});
}
//#endregion
export { signIn as a, cn as i, SiteFooter as n, SiteHeader as r, Button as t };
